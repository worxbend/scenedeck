...
audio-card-meter-tooltip-indicators = Balken: Spitzenpegel mit Abfall · Linie: lauteste Spitze in 20 s · Punkt: Lautheit · Fuss: Pegel vom Gerät
...
settings-hotkeys-description = Live-Szenen über die Tastatur wechseln. Die Platznummern folgen der im Inventar festgelegten Szenenreihenfolge.
